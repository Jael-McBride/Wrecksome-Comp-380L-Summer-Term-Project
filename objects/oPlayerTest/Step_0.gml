...
if (left == 1 /*&& abs(spd)*/ > 0.05 && (driftAngle >= 0 || driftCorrCheck == 1) ) { angle += (turnR + extraR); } 
if (right == 1 /*&& abs(spd)*/ > 0.05 && (driftAngle <= 0 || driftCorrCheck == 1) ) { angle -= (turnR + extraR); }
