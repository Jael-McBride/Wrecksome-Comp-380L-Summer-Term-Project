...
with(oPlayer)
	if (place_meeting(x,y,oChecked)){
		...
		if (instance_exists(oChecked) == 0){
			instance_create_layer(2208, 1008, "Instances", oFinishLine)
		}
...
with(oPlayer) {
	...
	if (global.lap <= 3){
		instance_create_layer(4864, 864, "Instances", oChecked)
		instance_create_layer(4596, 3232, "Instances", oChecked)
		instance_create_layer(2592, 2528, "Instances", oChecked)
		instance_create_layer(800, 2080, "Instances", oChecked)
		instance_create_layer(800, 992, "Instances", oChecked)
